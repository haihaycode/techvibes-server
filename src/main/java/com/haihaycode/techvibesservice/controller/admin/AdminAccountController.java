...
public class AdminAccountController {
    ...
    public ResponseEntity<ResponseWrapper<UserEntity>> updateUser(
        ...
        ResponseWrapper<UserEntity> response = new ResponseWrapper<>(HttpStatus.OK, "User updated successfully", updatedUser);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<ResponseWrapper<UserEntity>> updateUserAvailability(
        ...
        ResponseWrapper<UserEntity> response = new ResponseWrapper<>(HttpStatus.OK, "User availability updated successfully", updatedUser);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<ResponseWrapper<Void>> addUserRoles(
        ...
        return ResponseEntity.ok(new ResponseWrapper<>(HttpStatus.OK, "Roles added successfully", null));
