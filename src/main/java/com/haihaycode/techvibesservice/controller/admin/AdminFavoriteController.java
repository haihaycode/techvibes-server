...
public class AdminFavoriteController {
    ...
    public ResponseEntity<ResponseWrapper<Void>> addOrRemoveFavorite(@RequestParam Long userId, @RequestParam Long productId) {
        favoriteService.favorite(userId, productId);
        return ResponseEntity.ok(new ResponseWrapper<>(HttpStatus.OK, "Favorite retrieved successfully", null));
    }
}
